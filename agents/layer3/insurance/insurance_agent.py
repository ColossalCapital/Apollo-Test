"""
Smart Insurance - Tier 2 LLM-Powered Analysis
...
class InsuranceAgent(BaseAgent):
    """insurance policy analysis with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="InsuranceAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "agent": "Insurance",
            "description": "insurance policy analysis",
            "capabilities": ['policy analysis', 'coverage assessment', 'claim support']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['policy', 'coverage', 'claim'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a insurance policy analysis expert. Analyze this specific situation:
