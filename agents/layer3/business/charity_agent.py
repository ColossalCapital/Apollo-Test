"""
Smart Charity - Tier 2 LLM-Powered Analysis
...
class CharityAgent(BaseAgent):
    """charitable giving recommendations with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="CharityAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "agent": "Charity",
            "description": "charitable giving recommendations",
            "capabilities": ['charity evaluation', 'impact assessment', 'donation optimization']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['charity', 'donation', 'cause'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a charitable giving recommendations expert. Analyze this specific situation:
...
Consider:
1. What charities are effective?
