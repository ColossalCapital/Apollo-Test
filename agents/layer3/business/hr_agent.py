"""
Smart HR - Tier 2 LLM-Powered Analysis
...
class HRAgent(BaseAgent):
    """human resources and recruiting with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="SmartHRAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['candidate screening', 'culture fit', 'skill assessment']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['candidate', 'resume', 'interview'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a human resources and recruiting expert. Analyze this specific situation:
