"""
Smart Marketing - Tier 2 LLM-Powered Analysis
...
class MarketingAgent(BaseAgent):
    """marketing campaigns and analytics with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="MarketingAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['campaign analysis', 'ROI calculation', 'audience targeting']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['campaign', 'marketing', 'audience'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a marketing campaigns and analytics expert. Analyze this specific situation:
