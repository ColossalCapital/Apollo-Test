"""
Smart Nutrition - Tier 2 LLM-Powered Analysis
...
class NutritionAgent(BaseAgent):
    """meal analysis and nutrition tracking with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="NutritionAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "agent": "Nutrition",
            "description": "meal analysis and nutrition tracking",
            "capabilities": ['nutrition analysis', 'meal planning', 'dietary recommendations']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['meal', 'food', 'nutrition'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a meal analysis and nutrition tracking expert. Analyze this specific situation:
