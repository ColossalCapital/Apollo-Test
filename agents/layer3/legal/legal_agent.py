"""
Smart Legal - Tier 2 LLM-Powered Analysis
...
class LegalAgent(BaseAgent):
    """legal document analysis with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="LegalAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['contract analysis', 'risk assessment', 'compliance']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['contract', 'legal', 'terms'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a legal document analysis expert. Analyze this specific situation:
