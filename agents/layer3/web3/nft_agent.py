"""
Smart NFT - Tier 2 LLM-Powered Analysis
...
class NFTAgent(BaseAgent):
    """NFT valuation and marketplace data with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="SmartNFTAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "agent": "NFT",
            "description": "NFT valuation and marketplace data",
            "capabilities": ['NFT valuation', 'rarity analysis', 'market trends']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['nft', 'collection', 'rarity'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a NFT valuation and marketplace data expert. Analyze this specific situation:
