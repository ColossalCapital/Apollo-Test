"""
Smart Auction - Tier 2 LLM-Powered Analysis
...
class AuctionAgent(BaseAgent):
    """auction bidding strategies with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="AuctionAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "agent": "Auction",
            "description": "auction bidding strategies",
            "capabilities": ['bid optimization', 'auction analysis', 'strategy recommendation']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['auction', 'bid', 'strategy'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a auction bidding strategies expert. Analyze this specific situation:
