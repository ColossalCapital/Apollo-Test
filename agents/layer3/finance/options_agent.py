"""
Smart Options - Tier 2 LLM-Powered Analysis
...
class OptionsAgent(BaseAgent):
    """options trading strategies with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="OptionsAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['options analysis', 'strategy selection', 'Greeks calculation']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['option', 'strike', 'expiry', 'greeks'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a options trading strategies expert. Analyze this specific situation:
...
Consider:
1. What is the best options strategy?
2. What strike and expiry?
3. What are the Greeks?
4. What is the risk/reward?
