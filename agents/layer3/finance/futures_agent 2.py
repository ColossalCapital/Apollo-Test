"""
Smart Futures - Tier 2 LLM-Powered Analysis
...
class FuturesAgent(BaseAgent):
    """futures trading with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="FuturesAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['futures analysis', 'contract selection', 'margin calculation']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['futures', 'contract', 'margin'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a futures trading expert. Analyze this specific situation:
...
Consider:
1. Which futures contract is best?
2. What is the margin requirement?
3. What is the roll strategy?
