"""
Smart Broker - Tier 2 LLM-Powered Analysis
...
class SchwabBrokerAgent(BaseAgent):
    """traditional broker integrations with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="BrokerAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "agent": "Broker",
            "description": "traditional broker integrations",
            "capabilities": ['broker connection', 'order execution', 'portfolio sync']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['broker', 'order', 'execution'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a traditional broker integrations expert. Analyze this specific situation:
...
Consider:
1. Which broker is best for this trade?
2. What is the optimal execution strategy?
