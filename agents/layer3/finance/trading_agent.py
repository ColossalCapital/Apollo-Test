"""
Smart Trading - Tier 2 LLM-Powered Analysis
...
class TradingAgent(BaseAgent):
    """market analysis and trading signals with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="TradingAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "agent": "Trading",
            "description": "market analysis and trading signals",
            "capabilities": ['technical analysis', 'signal generation', 'risk assessment']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['price', 'market_data', 'asset'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a market analysis and trading signals expert. Analyze this specific situation:
...
2. What are the trading signals?
