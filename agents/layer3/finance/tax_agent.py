"""
Smart Tax - Tier 2 LLM-Powered Analysis
...
class TaxAgent(BaseAgent):
    """tax calculations and filing with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="TaxAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['tax calculation', 'deduction identification', 'filing assistance']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['income', 'expenses', 'deductions'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a tax calculations and filing expert. Analyze this specific situation:
...
Consider:
1. What deductions apply?
2. What is the estimated tax liability?
