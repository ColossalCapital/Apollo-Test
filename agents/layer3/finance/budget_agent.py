"""
Smart Budget - Tier 2 LLM-Powered Analysis
...
class BudgetAgent(BaseAgent):
    """budget planning and tracking with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="BudgetAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['budget creation', 'expense tracking', 'variance analysis']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['budget', 'expenses', 'income'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a budget planning and tracking expert. Analyze this specific situation:
