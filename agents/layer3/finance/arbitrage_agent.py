"""
Smart Arbitrage - Tier 2 LLM-Powered Analysis
...
class ArbitrageAgent(BaseAgent):
    """cross-exchange arbitrage with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="ArbitrageAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['arbitrage detection', 'execution planning', 'risk assessment']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['arbitrage', 'spread', 'exchanges'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a cross-exchange arbitrage expert. Analyze this specific situation:
...
Consider:
1. Is there a profitable arbitrage opportunity?
