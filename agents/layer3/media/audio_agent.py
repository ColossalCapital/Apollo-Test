"""
Smart Audio - Tier 2 LLM-Powered Analysis
...
class AudioAgent(BaseAgent):
    """audio transcription with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="AudioAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['speech-to-text', 'speaker identification', 'sentiment analysis']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['audio', 'speech', 'voice'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a audio transcription expert. Analyze this specific situation:
