"""
Smart Video - Tier 2 LLM-Powered Analysis
...
class VideoAgent(BaseAgent):
    """video analysis with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="VideoAgent", model="phi-3-medium")
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['video', 'clip', 'footage'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a video analysis expert. Analyze this specific situation:
...
2. What are the key scenes?
3. Is there inappropriate content?
