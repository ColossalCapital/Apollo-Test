"""
Smart Music - Tier 2 LLM-Powered Analysis
...
class MusicAgent(BaseAgent):
    """music analysis and generation with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="MusicAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "agent": "Music",
            "description": "music analysis and generation",
            "capabilities": ['music analysis', 'genre classification', 'mood detection']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['music', 'song', 'audio'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a music analysis and generation expert. Analyze this specific situation:
