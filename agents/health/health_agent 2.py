"""
Smart Health - Tier 2 LLM-Powered Analysis
...
class HealthAgent(BaseAgent):
    """PHI analysis and health tracking with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="HealthAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "agent": "Health",
            "description": "PHI analysis and health tracking",
            "capabilities": ['health tracking', 'symptom analysis', 'wellness recommendations']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['symptoms', 'health', 'wellness'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a PHI analysis and health tracking expert. Analyze this specific situation:
...
Consider:
1. What are the health indicators?
