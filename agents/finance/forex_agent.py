"""
Smart Forex - Tier 2 LLM-Powered Analysis
...
class ForexAgent(BaseAgent):
    """foreign exchange trading with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="ForexAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['currency analysis', 'pair trading', 'risk management']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['currency_pair', 'exchange_rate', 'forex_data'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a foreign exchange trading expert. Analyze this specific situation:
...
Consider:
1. What is the currency pair outlook?
