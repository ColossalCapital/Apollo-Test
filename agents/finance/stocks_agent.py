"""
Smart Stocks - Tier 2 LLM-Powered Analysis
...
class StocksAgent(BaseAgent):
    """stock market analysis with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="StocksAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['stock analysis', 'valuation', 'recommendation']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['ticker', 'stock_data', 'financials'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a stock market analysis expert. Analyze this specific situation:
...
Consider:
1. What is the stock's valuation?
