"""
Smart Ledger - Tier 2 LLM-Powered Analysis
...
class LedgerAgent(BaseAgent):
    """accounting and bookkeeping with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="LedgerAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['transaction categorization', 'tax deductibility', 'recurring detection']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['transaction', 'amount', 'description'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a accounting and bookkeeping expert. Analyze this specific situation:
...
Consider:
1. What is the correct category?
2. Is this tax deductible?
3. Is this a recurring transaction?
