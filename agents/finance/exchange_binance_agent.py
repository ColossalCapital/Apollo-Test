"""
Smart Exchange - Tier 2 LLM-Powered Analysis
...
class ExchangeAgent(BaseAgent):
    """crypto exchange integrations with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="ExchangeAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "agent": "Exchange",
            "description": "crypto exchange integrations",
            "capabilities": ['exchange connection', 'crypto trading', 'liquidity analysis']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['exchange', 'crypto', 'liquidity'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a crypto exchange integrations expert. Analyze this specific situation:
...
Consider:
1. Which exchange has the best liquidity?
2. What are the fees?
3. What is the execution quality?
