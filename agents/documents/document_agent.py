"""
Smart Document - Tier 2 LLM-Powered Analysis
...
class DocumentAgent(BaseAgent):
    """document parsing and analysis with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="DocumentAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['document parsing', 'entity extraction', 'summarization']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['document', 'content', 'text'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a document parsing and analysis expert. Analyze this specific situation:
