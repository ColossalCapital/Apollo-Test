"""
Smart Translation - Tier 2 LLM-Powered Analysis
...
class TranslationAgent(BaseAgent):
    """multi-language translation with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="TranslationAgent", model="phi-3-medium")
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['text', 'language', 'translate'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a multi-language translation expert. Analyze this specific situation:
...
Consider:
1. What is the accurate translation?
2. Are there cultural considerations?
