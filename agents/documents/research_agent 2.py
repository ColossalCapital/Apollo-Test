"""
Smart Research - Tier 2 LLM-Powered Analysis
...
class ResearchAgent(BaseAgent):
    """research and information gathering with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="ResearchAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['web research', 'fact checking', 'source verification']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['topic', 'research', 'question'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a research and information gathering expert. Analyze this specific situation:
