"""
Smart Deployment - Tier 2 LLM-Powered Analysis
...
class DeploymentAgent(BaseAgent):
    """CI/CD and deployment automation with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="DeploymentAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['deployment planning', 'rollback strategies', 'monitoring']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['deployment', 'release', 'environment'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a CI/CD and deployment automation expert. Analyze this specific situation:
