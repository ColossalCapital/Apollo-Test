"""
Smart GitHub - Tier 2 LLM-Powered Analysis
...
class GitHubAgent(BaseAgent):
    """repository management and code analysis with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="SmartGitHubAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['code analysis', 'PR review', 'issue tracking']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['code', 'repository', 'pull_request'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a repository management and code analysis expert. Analyze this specific situation:
