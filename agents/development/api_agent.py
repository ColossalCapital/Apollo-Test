"""
Smart API - Tier 2 LLM-Powered Analysis
...
class APIAgent(BaseAgent):
    """API integration and testing with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="SmartAPIAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['API testing', 'integration', 'documentation']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['api', 'endpoint', 'integration'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a API integration and testing expert. Analyze this specific situation:
...
Consider:
1. Is the API properly documented?
