"""
Smart Contact - Tier 2 LLM-Powered Analysis
...
class ContactAgent(BaseAgent):
    """contact management and CRM with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="ContactAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['contact enrichment', 'relationship tracking', 'communication history']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['contact', 'person', 'company'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a contact management and CRM expert. Analyze this specific situation:
...
2. What is the communication history?
