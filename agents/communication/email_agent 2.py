"""
Smart Email - Tier 2 LLM-Powered Analysis
...
class EmailAgent(BaseAgent):
    """email intelligence and automation with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="EmailAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "agent": "Email",
            "description": "email intelligence and automation",
            "capabilities": ['sentiment analysis', 'urgency detection', 'action items', 'entity extraction']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['email_content', 'body', 'subject'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a email intelligence and automation expert. Analyze this specific situation:
...
Consider:
1. What is the sentiment and urgency?
2. What action items are required?
3. Who are the key people/entities mentioned?
