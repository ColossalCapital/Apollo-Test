"""
Smart Calendar - Tier 2 LLM-Powered Analysis
...
class CalendarAgent(BaseAgent):
    """calendar optimization and scheduling with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="CalendarAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['meeting scheduling', 'conflict detection', 'time optimization']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['event', 'meeting', 'schedule'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a calendar optimization and scheduling expert. Analyze this specific situation:
...
Consider:
1. Are there any scheduling conflicts?
2. Is this the optimal time for this meeting?
