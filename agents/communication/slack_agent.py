"""
Smart Slack - Tier 2 LLM-Powered Analysis
...
class SlackAgent(BaseAgent):
    """team communication analysis with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="SlackAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['message analysis', 'sentiment tracking', 'team dynamics']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['message', 'channel', 'thread'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a team communication analysis expert. Analyze this specific situation:
...
Consider:
1. What is the team sentiment?
2. Are there any issues or blockers?
