"""
Smart Risk - Tier 2 LLM-Powered Analysis
...
class RiskAgent(BaseAgent):
    """risk assessment and management with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="RiskAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['risk analysis', 'mitigation planning', 'insurance recommendations']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['risk', 'threat', 'vulnerability'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a risk assessment and management expert. Analyze this specific situation:
...
3. What mitigation is needed?
4. What insurance is recommended?
