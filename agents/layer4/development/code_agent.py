"""
Smart CodeReview - Tier 2 LLM-Powered Analysis
...
class CodeReviewAgent(BaseAgent):
    """automated code review with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="SmartCodeReviewAgent", model="phi-3-medium")
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['code', 'diff', 'changes'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a automated code review expert. Analyze this specific situation:
