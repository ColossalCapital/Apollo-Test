"""
Smart Integration - Tier 2 LLM-Powered Analysis
...
class IntegrationAgent(BaseAgent):
    """third-party integrations with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="IntegrationAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['API integration', 'webhook management', 'data sync']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['integration', 'api', 'webhook'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a third-party integrations expert. Analyze this specific situation:
...
Consider:
1. How should this be integrated?
