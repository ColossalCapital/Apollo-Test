"""
Smart Schema - Tier 2 LLM-Powered Analysis
...
class SchemaAgent(BaseAgent):
    """schema management with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="SchemaAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['schema design', 'validation', 'migration']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['schema', 'database', 'model'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a schema management expert. Analyze this specific situation:
