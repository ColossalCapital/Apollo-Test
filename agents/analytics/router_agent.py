"""
Smart Router - Tier 2 LLM-Powered Analysis
...
class RouterAgent(BaseAgent):
    """intelligent routing with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="RouterAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['content routing', 'agent selection', 'workflow orchestration']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['route', 'workflow', 'orchestration'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a intelligent routing expert. Analyze this specific situation:
