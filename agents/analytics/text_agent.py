"""
Smart Text - Tier 2 LLM-Powered Analysis
...
class TextAgent(BaseAgent):
    """text analysis and NLP with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="TextAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['text analysis', 'sentiment', 'entity extraction']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['text', 'content', 'document'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a text analysis and NLP expert. Analyze this specific situation:
