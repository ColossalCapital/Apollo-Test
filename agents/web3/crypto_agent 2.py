"""
Smart Crypto - Tier 2 LLM-Powered Analysis
...
class CryptoAgent(BaseAgent):
    """cryptocurrency analysis and DeFi with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="CryptoAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "agent": "Crypto",
            "description": "cryptocurrency analysis and DeFi",
            "capabilities": ['crypto analysis', 'DeFi protocols', 'wallet tracking']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['crypto', 'defi', 'blockchain'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a cryptocurrency analysis and DeFi expert. Analyze this specific situation:
