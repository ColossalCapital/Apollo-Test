"""
Smart Compliance - Tier 2 LLM-Powered Analysis
...
class ComplianceAgent(BaseAgent):
    """regulatory compliance with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="ComplianceAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['compliance checking', 'regulation tracking', 'audit support']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['compliance', 'regulation', 'audit'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a regulatory compliance expert. Analyze this specific situation:
