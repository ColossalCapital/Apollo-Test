"""
Smart IP - Tier 2 LLM-Powered Analysis
...
class IPAgent(BaseAgent):
    """intellectual property management with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="SmartIPAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['IP analysis', 'patent search', 'trademark checking']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['patent', 'trademark', 'copyright'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a intellectual property management expert. Analyze this specific situation:
