"""
Smart Slang - Tier 2 LLM-Powered Analysis
...
class SlangAgent(BaseAgent):
    """modern slang and language with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="SlangAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "agent": "Slang",
            "description": "modern slang and language",
            "capabilities": ['slang translation', 'trend detection', 'cultural context']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['slang', 'language', 'phrase'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a modern slang and language expert. Analyze this specific situation:
