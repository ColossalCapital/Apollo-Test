"""
Smart Meme - Tier 2 LLM-Powered Analysis
...
class MemeAgent(BaseAgent):
    """meme analysis and generation with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="MemeAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "agent": "Meme",
            "description": "meme analysis and generation",
            "capabilities": ['meme analysis', 'trend detection', 'generation']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['meme', 'image', 'viral'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a meme analysis and generation expert. Analyze this specific situation:
