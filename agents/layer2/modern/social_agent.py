"""
Smart Social - Tier 2 LLM-Powered Analysis
...
class SocialAgent(BaseAgent):
    """social media analysis with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="SocialAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['social analysis', 'engagement tracking', 'trend detection']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['social', 'post', 'engagement'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a social media analysis expert. Analyze this specific situation:
