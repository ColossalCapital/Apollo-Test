"""
Smart Materialize - Tier 2 LLM-Powered Analysis
...
class MaterializeAgent(BaseAgent):
    """real-time data stream queries with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="MaterializeAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "agent": "Materialize",
            "description": "real-time data stream queries",
            "capabilities": ['stream processing', 'real-time queries', 'materialized views']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['stream', 'real-time', 'query'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a real-time data stream queries expert. Analyze this specific situation:
