"""
Smart Data - Tier 2 LLM-Powered Analysis
...
class DataAgent(BaseAgent):
    """data analysis and visualization with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="DataAgent", model="phi-3-medium")
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['data', 'dataset', 'metrics'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a data analysis and visualization expert. Analyze this specific situation:
...
3. What visualizations are helpful?
