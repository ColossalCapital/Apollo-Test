"""
Smart Scraper - Tier 2 LLM-Powered Analysis
...
class ScraperAgent(BaseAgent):
    """web scraping and data extraction with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="ScraperAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['web scraping', 'data extraction', 'content parsing']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['url', 'website', 'scrape'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a web scraping and data extraction expert. Analyze this specific situation:
