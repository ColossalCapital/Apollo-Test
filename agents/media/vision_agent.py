"""
Smart Vision - Tier 2 LLM-Powered Analysis
...
class VisionAgent(BaseAgent):
    """image analysis with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="VisionAgent", model="phi-3-medium")
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['image', 'photo', 'visual'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a image analysis expert. Analyze this specific situation:
