"""
Smart Sales - Tier 2 LLM-Powered Analysis
...
class SalesAgent(BaseAgent):
    """sales pipeline and CRM with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="SalesAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['lead scoring', 'pipeline management', 'forecasting']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['lead', 'opportunity', 'deal'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a sales pipeline and CRM expert. Analyze this specific situation:
...
Consider:
1. What is the lead quality?
2. What is the close probability?
