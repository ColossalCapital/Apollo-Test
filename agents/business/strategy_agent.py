"""
Smart Strategy - Tier 2 LLM-Powered Analysis
...
class BusinessStrategyAgent(BaseAgent):
    """business strategy and planning with LLM-powered analysis"""
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['strategy', 'market', 'competition'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a business strategy and planning expert. Analyze this specific situation:
