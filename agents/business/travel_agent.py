"""
Smart Travel - Tier 2 LLM-Powered Analysis
...
class TravelAgent(BaseAgent):
    """travel optimization and booking with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="TravelAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "agent": "Travel",
            "description": "travel optimization and booking",
            "capabilities": ['travel planning', 'cost optimization', 'itinerary management']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['travel', 'destination', 'itinerary'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a travel optimization and booking expert. Analyze this specific situation:
...
Consider:
1. What is the optimal itinerary?
