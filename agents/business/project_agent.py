"""
Smart Project - Tier 2 LLM-Powered Analysis
...
class ProjectAgent(BaseAgent):
    """project management with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="ProjectAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "capabilities": ['project planning', 'risk assessment', 'timeline estimation']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['project', 'task', 'milestone'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a project management expert. Analyze this specific situation:
