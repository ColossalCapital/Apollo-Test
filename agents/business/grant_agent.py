"""
Smart Grant - Tier 2 LLM-Powered Analysis
...
class GrantScraperAgent(BaseAgent):
    """grant discovery and application with LLM-powered analysis"""
    
    def __init__(self):
        super().__init__(name="SmartGrantScraperAgent", model="phi-3-medium")
    ...
    def get_static_knowledge(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "agent": "Grant",
            "description": "grant discovery and application",
            "capabilities": ['grant search', 'eligibility checking', 'application support']
        }
    ...
    def _should_use_llm(self, data: Dict[str, Any]) -> bool:
        ...
        return any(key in data for key in ['grant', 'funding', 'eligibility'])
    ...
    async def analyze_with_llm(self, data: Dict[str, Any], static_knowledge: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a grant discovery and application expert. Analyze this specific situation:
...
4. What is the success probability?
